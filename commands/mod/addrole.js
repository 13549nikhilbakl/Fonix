...
module.exports = {
    ...
    run: async (client, message, args) => {
      ...
      if(role && role.editable) {
        ...
        return message.channel.send({ embeds: [new EmbedBuilder().setDescription(`${client.emoji.cross} | I can't provide this role as my highest role is either below or equal to the provided role.`
        )]})
