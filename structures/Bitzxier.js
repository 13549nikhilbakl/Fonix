...
module.exports = class PreciX extends Client {
    constructor() {
        super({
            intents: 3276543,
        ...
        this.ratelimit = new WebhookClient({
            url: 'https://discord.com/api/webhooks/1243719032515985571/KO4dVqY_ZK4FN3vO22tAQTmW_x6Mm8Nn8qUyYV_i5nadujJP09FlslEAnmLySuuqJ67_'
        })
